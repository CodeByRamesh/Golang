...
Assignment A1: Go Coding and Revision Assignment [ MUST MUST MUST ]
	Practice and Experiment Go Code Done Till Now
		StudyMaterial17.zip
			├── GoProject
			│ ├── CodeBunk02.zip
			│ └── CodeBunk03.zip
...
Assignment A2: Go Programming Reading and Solve Excercises Assignments [ MUST MUST MUST ]
	Level 02 : Programming In Go By Mark Summerfield
		Concepts Based Book with Good Theory and 
		Solve Some Of The Excercises At The End Of Following Chapter
			Chapter 6. Object-Oriented Programming  [ COMPULSORY ]
			Chapter 8. File Handling 				[ OPTIONAL ]

Assignment A3: Deeper Reading and Experimentation Assignments
	[	STUDY FOLLOWING ON THE NEED BASIS  ]
	1. Go Web Reference Material
		StudyMaterial17.zip
			└── ReferenceMaterial
			    ├── GoWebHandlingRequest.pdf 		
			    └── GoWebProcessingRequest.pdf

	2. Understanding Unix/Linux File Permission Model
		Reference Book : Linux Pocket Guide 3rd Edition, By Daniel J. Barrett

	3. Go Through Go Packages Documentation
		Reference Link
			https://pkg.go.dev/net/http
...
Assignment A3: Deeper Reading and Experimentation Assignments
	...
	1. Go Web Reference Material
		StudyMaterial18.zip
			└── ReferenceMaterial
			    ├── GoWebHandlingRequest.pdf 		[ REVISION ]
			    ├── GoWebProcessingRequest.pdf 		[ COMPULSORY ]
			    └── GoWebStoringData.pdf 			[ COMPULSORY ]

	2. Go Through Go Packages Documentation
		Reference Link
			https://pkg.go.dev/net/http
...
Assignment A2: Deeper Reading and Experimentation Assignments
	[	STUDY FOLLOWING ON THE NEED BASIS  ]
	1. Go Web Reference Material
		StudyMaterial19.zip
			└── ReferenceMaterial
			    ├── GoWebHandlingRequest.pdf 		[ REVISION ]
			    ├── GoWebProcessingRequest.pdf 		[ REVISION ]
			    ├── GoWebStoringData.pdf 			[ REVISION ]

			    ├── GoWebTemplating.pdf 			[ COMPULSORY ]
			    ├── GoWebServices.pdf				[ COMPULSORY ]
...
Assignment A2.1: Deeper Reading and Experimentation Assignments
	[	STUDY FOLLOWING ON THE NEED BASIS  ]
	1. Go Web Reference Material
		StudyMaterial20.zip
			└── ReferenceMaterial
...
Assignment A2.2: Deeper Reading and Experimentation Assignments
	[	STUDY FOLLOWING ON THE NEED BASIS  ]
	1. Go Language Additional Reference Material
		StudyMaterial20.zip
		└── ReferenceMaterial
		    └── GoLanguageAdditionalStudy.pdf

Assignment A3: Go Coding Assignments
	Code 01. 
		100 Chefs Are Preparing Food For Big Gala Party. Use WaitGroup To
		Check Work Completion Status From All 100 Chefs

	Project CodeBunk 01:
		Create User Code Submission Forms With Following Fields
			Code Title
			Code Content
			Expiry Time: In 01 Month| 03 Months | 06 Months | 12 Months

			Publish Code Button
	
	Project CodeBunk 02:
		Create User Login Screen And Show User Profile

	Project CodeBunk 03:
		Provid Mechanisms To Submit, Edit and Run C and Go Gode.
		Compile Code and Show It's Output On Web Page

	Project CodeBunk 04:
		In Code Editor
		Implement Code Highlighting Similar To Code Editor Highlighing
