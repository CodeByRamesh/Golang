...
func playWithUserInput() {
	...
	// Asking Scanner Object To Scan From Standard Input ( Stdin )
	// Stdin By Default Poining To Keyboard javaScan Will Stop Reading From Stdin Moment It Gets EOF
...
func playWithUserInputAndCountDuplicateLines() {
	fmt.Println("playWithUserInputAndCountDuplicateLines::")
